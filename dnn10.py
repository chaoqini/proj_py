...
def batch(params,lr0=0,klr=0,batch=0,batches=0,isplot=0,istime=0):
...
(nx,nz0,nz1,ny)=(28*28,100,100,10)
...
## ==========
params=batch(params,0.5,0.998,40,0,1,1)
## ==========
## valid
print('Valid running ...')
## ==========
...
## ==========
# ==========
#with open('dnn_p3.pkl','wb') as f: pickle.dump(params,f);print('params write in %s'%f.name)
## ==========
## ==========
## grade check
