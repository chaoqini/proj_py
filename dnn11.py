...
#        w2=np.random.randn(nz2,nz1)*1e-3
...
#        (l,OP,p)=(3,{},params)
        ...
        OP['A-1']=X
#        print('fp:w0.shape=',p['w0'].shape)
#        print('fp:b0.shape=',p['b0'].shape)
#        print('fp:A-1.shape=',OP['A-1'].shape)
        for i in range(l):
#            print('fp:i=',i)
            OP['Z'+str(i)]=p['w'+str(i)]@OP['A'+str(i-1)]+p['b'+str(i)]
            OP['A'+str(i)]=dnn.g[i](OP['Z'+str(i)])
        Y=OP['A'+str(l-1)]
#        print('fp: OP.keys()=',OP.keys())
#        Z0=w0@X+b0
#        A_1=X
#        Z0=w0@A_1+b0
#        A0=dnn.g[0](Z0)
...
#        d_Y=Y-YL
#        d_Z3=d_Y
#        (l,d_,p)=(int(len(params)/2),{},params)
#        d_['Z'+str(l-1)]=Y-YL
